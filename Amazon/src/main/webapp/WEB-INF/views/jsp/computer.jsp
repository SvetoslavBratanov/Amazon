...
<body>
		<body style="background-color:powderblue;">
			...
			<nav class="col-md-6"> <img
				src="<c:url value="/resources/static${computer.poster}"/>" height="150" width="150">
			<br>
			...
			<h1>
				<c:out value="Price: ${computer.price}" />
			</h1>
			
			<h1>
				<c:out value="SSD: ${computer.ssd}" />
			</h1>
			
			
			<h1>
				<c:out value="RAM: ${computer.ram}" />
			</h1>
</body>
</html>